...
if "GOOGLE_API_KEY" not in os.environ:
    os.environ["GOOGLE_API_KEY"] = "AIzaSyDOxdAHdRuvKJMRz4URnC0uQdDW5frAU3w"
...
def researchAgent(query, llm):
  ...
  #Quando verbose é marcado como True no terminal aparece o passo a passo de cada iteração (Action, Action Input, Summary...)
